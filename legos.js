...
tlMaster
  .to(
    "#lego-one",
    0.4,
    { x: -70, y: -70, ease: Power4.easeInOut },
    "slide_one+=0.0"
  )
  ...
  .to(
    "#lego-one",
    0.4,
    { x: 0, y: -140, ease: Power4.easeInOut },
    "slide_two+=0.5"
  )
  ...
  .to(
    "#lego-two",
    0.4,
    { x: -140, y: -0, ease: Power4.easeInOut },
    "slide_three+=0.0"
  )
  ...
  .to(
    "#lego-three",
    0.4,
    { x: -140, y: 140, ease: Power4.easeInOut },
    "slide_three+=0.4"
  )
  .to(
    "#lego-five",
  ...
  .to(
    "#lego-one",
    0.4,
    { x: 70, y: -210, ease: Power4.easeInOut },
    "slide_four+=0.4"
  )
  .to(
    "#lego-two",
  ...
  .to(
    "#lego-three",
    0.4,
    { x: -210, y: 70, ease: Power4.easeInOut },
    "slide_five+=0.0"
  )
